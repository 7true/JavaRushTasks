    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                double double1 = (stock1.containsKey("last") ? (double) stock1.get("last") : 0.0) -
                        (stock1.containsKey("open") ? (double) stock1.get("open") : 0.0);

                double double2 = (stock2.containsKey("last") ? (double) stock2.get("last") : 0.0) -
                        (stock2.containsKey("open") ? (double) stock2.get("open") : 0.0);
